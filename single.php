    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <?php if ( $thumbnail_type == 'wide' || $thumbnail_type == 'full' || $thumbnail_type == 'fullscreen' ): ?>
            ...
            <?php if ( ! empty( $thumb_url ) && $is_show_thumb ): ?>
                ...
                <?php if ( $thumbnail_caption && ! empty ( $thumb_caption ) ) echo '<figcaption class="entry-image--' . $thumbnail_type . '-caption wp-caption-text" style="margin-bottom: 20px;">' . get_the_post_thumbnail_caption() . '</figcaption>' ?>
            <?php endif; ?>
